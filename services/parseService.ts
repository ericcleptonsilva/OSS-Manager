  ...
  try {
    ...
    try {
      ...
      if (team) {
        ...
        // Security: Prevent empty-string authentication bypass by ensuring credentials are not empty
      ...
      if (academy) {
        ...
        // Security: Prevent empty-string authentication bypass for Professor access
        if (storedProfPass && storedProfPass !== '' && storedProfPass === pass) {
