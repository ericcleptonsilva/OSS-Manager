    ...
    try {
      ...
      if (team) {
        ...
        if (
          storedAdminEmail &&
          storedAdminPass &&
          typeof storedAdminEmail === 'string' &&
          typeof storedAdminPass === 'string' &&
          storedAdminEmail.trim() !== '' &&
          storedAdminPass.trim() !== '' &&
          normalizedEmail === storedAdminEmail.trim().toLowerCase() &&
