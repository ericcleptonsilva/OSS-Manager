  ...
  try {
    ...
    try {
      ...
      if (team) {
        ...
        // Ensure credentials are set and not empty strings to prevent bypass
      ...
      if (academy) {
        ...
        // Ensure stored password is not empty to prevent bypass
        if (storedProfPass && pass === storedProfPass) {
